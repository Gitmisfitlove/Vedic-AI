import { MakeTime, Ecliptic, GeoVector, Body, SiderealTime } from 'astronomy-engine';
const ZODIAC_SIGNS = [
...
export const getSignName = (signIndex) => {
...
const getAscendant = (time, lat, lon, ayanamsa) => {
    ...
    const gstOfDate = SiderealTime(time);
...
export const calculateKundali = (details) => {
